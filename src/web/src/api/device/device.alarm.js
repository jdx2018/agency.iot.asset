 ...
 * 查询所有设备邮件报警记录列表：
 */
async function getDeviceAlarmList(filter) {
    const viewDef = cache.view_get().deviceAlarm;
...
module.exports.getDeviceAlarmList = getDeviceAlarmList;
