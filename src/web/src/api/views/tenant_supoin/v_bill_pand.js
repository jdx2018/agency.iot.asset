...
const typeDef = {
    ...
    prefix: "PD",
    status: {
        panding: { value: 0, desc: "盘点中" },
        notChecked: { value: 1, desc: "待审核" },
...
const objTemplate = {
    ...
    useOrgId: {
        ...
        dataSource: [],
        useWidget: { widgetName: "orgPicker" }
    },
    ownOrgId: {
        required: false,
        desc: "所属部门",
    ...
    placeId: {
        ...
        dataSource: [],
        useWidget: { widgetName: "assetPlacePicker" }
    },
    classId: {
        required: false,
        desc: "资产分类",
        ...
        dataSource: [],
        useWidget: { widgetName: "assetClassPicker" }
    }
}
/**
 * 单据列表界面高级筛选配置
