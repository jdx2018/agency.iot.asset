...
export default React.memo(
  ({ open, closeDialog, dialogData = { billMain: {}, billDetail: {} }, type, getAssetListFunc, billTitle, selectedRowKey }) => {
    ...
    const onFinish = async (values) => {
      ...
      const func = type === 'create' ? clientService.bill_tuiku.saveBill.bind(null, billMain_, assetList) : clientService.bill_tuiku.updateBill.bind(null, selectedRowKey, billMain_)
      ...
      <Modal
        ...
        <Scrollbars style={{
          ...
          >
            ...
            >
              <AssetsPicker getAssetListFunc={getAssetListFunc} type={type} pickerConfig={billDetail} />
            </Form.Item>
          </Form>
        </Scrollbars>
      </Modal>
