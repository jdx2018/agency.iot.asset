...
import { exportDestributeExcleStament } from './DestributeExcelStament';
...
export default React.memo(
  ({
    ...
    const onFinish = async (values) => {
      ...
      const func =
        type === 'create'
          ? clientService.bill_paifa.saveBill.bind(null, billMain_, assetList)
          : clientService.bill_paifa.updateBill.bind(null, selectedRowKey, billMain_);
    ...
    function handleExportStament() {
      ...
      exportDestributeExcleStament(mainLendInfo, subLendInfo, `派发申请表-${dayjs().format('YYYY-MM-DD')}`);
    }
