...
import { AdvanSearch, SearchInput, ColumnMenuSwitch, RefreshBtn, FilesIOBtnGroup } from 'components';

export default React.memo(
  ({ originData, columns, setColumn, refreshData, setFilterData, filterConfig, filterData }) => {
