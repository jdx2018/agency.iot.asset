...
export function exporMaterialOutExcleStament(mainLendInfo = {}, subLendInfo = {}, excelName = "借用申请表") {
  let {
    billNo = "",
    useEmployeeName = "",
    useDate = "",
  ...
  let bill = [
    ...
    ["A2", "J2", { value: "中远海运（青岛）有限公司耗材(物品)出库申请表", style: billTitleStyle }],
    ...
    ["G3", "G3", { value: "使用部门", style: defaultStyle }],
    ["H3", "J3", { value: useOrgName, style: defaultStyle }],

    ["A4", "A4", { value: "经办人", style: defaultStyle }],
    ["B4", "C4", { value: operatePersonId, style: defaultStyle }],
    ["D4", "J4", { value: "" }],
