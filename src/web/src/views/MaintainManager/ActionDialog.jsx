...
export default React.memo(
  ({ open, closeDialog, type, billTitle, dialogData, getAssetListFunc, selectedRowKey }) => {
    ...
    const onFinish = async (values) => {
      ...
      const func = type === 'create' ? clientService.bill_weixiu.saveBill.bind(null, billMain_, assetList) : clientService.bill_weixiu.updateBill.bind(null, selectedRowKey, billMain_)
