...
export default React.memo(
  ({ open, closeDialog, type, billTitle, dialogData, getAssetListFunc, selectedRowKey }) => {
    ...
    const onFinish = async (values) => {
      ...
      const func = type === 'create' ? clientService.bill_chuzhi.saveBill.bind(null, billMain_, assetList) : clientService.bill_chuzhi.updateBill.bind(null, selectedRowKey, billMain_)
