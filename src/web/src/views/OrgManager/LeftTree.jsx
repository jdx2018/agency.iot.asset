...
const uploadConfig = {
  getTemplateFunc: clientService.exportImport.org.getTemplate,
  checkFunc: clientService.exportImport.org.check,
  uploadFunc: clientService.org.addOrgList,
};
  ...
  ({
    ...
    const handleEdit = React.useCallback(
      (nodeKey, e) => {
        ...
        [currentorgId, currentorgName, orgId] = [
          cur_node.orgId,
          cur_node.orgName,
          cur_node.parentId,
        ];
    ...
    const handleAddMenuClick = React.useCallback(
      (nodeKey, e) => {
        ...
        if (e.key === "同级组织") {
          parentOrgId = orgFlatData.find(
            (org) => org.orgId === nodeKey
          ).parentId;
        } else {
          parentOrgId = nodeKey;
        }
              ...
              <Space>
                {
                  <Dropdown
                    overlay={
                      <Menu
                        onClick={handleAddMenuClick.bind(null, nodeData.key)}
                      >
                        {nodeData.key !== topTreeId ? (
                          <Menu.Item key="同级分类">同级分类</Menu.Item>
                        ) : null}
                  ...
                  >
                    <PlusOutlined
                      ...
                      style={{
                        color:
                          selectedKeys[0] === nodeData.key ? "#fff" : "#00bcd4",
