...
module.exports.hashCode = function (str) {
    ...
    return Math.abs(hash).toString().PadRight(10, "0");
}
module.exports.djb2Code = function (str) {
    var hash = 5381;
    for (i = 0; i < str.length; i++) {
        char = str.charCodeAt(i);
...
module.exports.sdbmCode = function (str) {
    var hash = 0;
    for (i = 0; i < str.length; i++) {
        char = str.charCodeAt(i);
...
module.exports.loseCode = function (str) {
    var hash = 0;
    for (i = 0; i < str.length; i++) {
        char = str.charCodeAt(i);
        hash += char;
