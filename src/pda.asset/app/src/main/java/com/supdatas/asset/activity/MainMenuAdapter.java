...
public class MainMenuAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
	...
	public MainMenuAdapter(Context context, List<MainMenuEntity> datas) {
	...
	public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
		...
		vh = new VH(View.inflate(context, R.layout.item_main_menu, null), this);
		return vh;*/
	...
	public static class VH extends RecyclerView.ViewHolder {
		...
		VH(View view, MainMenuAdapter a1) {
			super(view);
			adapter = a1;
