 ...
 * Desc:
 */
public class AssetPlaceEntity implements Serializable {

    public static String TABLE_NAME = TableName.TENANT_ASSET_PLACE;
    public static String[] TABLE_COLUMNS = new String[]{
            "tenantId", "placeId", "placeName", "parentPlaceId", "createPerson",
            "createTime", "updatePerson", "updateTime", "remarks"
    };
