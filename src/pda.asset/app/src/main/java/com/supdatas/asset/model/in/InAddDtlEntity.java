...
public class InAddDtlEntity {

	public static String TABLE_NAME_ADD = "stock_add_in_detail";
	public static String []TABLE_COLUMNS_ADD = new String[]{
			"billNo","archiveNo","epc","archiveDepartment","roomId","accountBank","accountOrgName",
			"accountstatus","openDate","destructDate","status","stockInDate","createTime","createPerson",
			"customerNo","customerName"
	};

	public InAddDtlEntity(){
	...
	public static Object getFields(InBillTypeEnum billTypeEnum) throws Exception {
		...
		for (int i = 0; i < TABLE_COLUMNS_ADD.length; ++i) {
			jsonObject.put(TABLE_COLUMNS_ADD[i], 1);
		}
		return jsonObject;
	}
...
//				updateItem.put("tableName", TABLE_NAME_ADD);
//
//				query.put("billNo", billNo);
...
//		}
	...
	public String getDataRequestJson(InBillTypeEnum billTypeEnum, String billNo, String sn) throws JSONException {
		...
		jsonObject.put("tableName", TABLE_NAME_ADD);
